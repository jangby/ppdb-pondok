            ...
            @if($errors->any())
                <div class="bg-red-50 border-l-4 border-red-500 p-4 mb-6 rounded shadow-sm">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm leading-5 font-medium text-red-800">Terdapat kesalahan pada inputan Anda</h3>
            ...
            <form action="{{ route('admin.candidates.store') }}" method="POST">
                ...
                <div class="bg-white shadow-md rounded-xl overflow-hidden mb-6 border border-gray-100">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div class="lg:col-span-2">
                            ...
                            <input type="text" name="nama_lengkap" value="{{ old('nama_lengkap') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required placeholder="Sesuai Ijazah SD/SMP">
                        </div>
                        <div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">NISN <span class="text-gray-400 text-xs">(Opsional)</span></label>
                            <input type="text" name="nisn" value="{{ old('nisn') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">NIK <span class="text-gray-400 text-xs">(Opsional)</span></label>
                            <input type="text" name="nik" value="{{ old('nik') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">No. KK <span class="text-gray-400 text-xs">(Opsional)</span></label>
                            <input type="text" name="no_kk" value="{{ old('no_kk') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" name="anak_ke" value="{{ old('anak_ke') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Jumlah Saudara</label>
                            <input type="number" name="jumlah_saudara" value="{{ old('jumlah_saudara') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-1">Asal Sekolah</label>
                            <input type="text" name="asal_sekolah" value="{{ old('asal_sekolah') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Contoh: SDN 1 Tasik">
                        </div>
                        
                        <div class="lg:col-span-3">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Riwayat Penyakit (Jika ada)</label>
                            <input type="text" name="riwayat_penyakit" value="{{ old('riwayat_penyakit') }}" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" placeholder="Tulis '-' jika sehat walafiat">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white shadow-md rounded-xl overflow-hidden mb-6 border border-gray-100">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-6">
                        <div class="lg:col-span-6">
                            <label class="block text-sm font-medium text-gray-700 mb-1">Alamat Lengkap (Jalan/Blok/Kp) <span class="text-red-500">*</span></label>
                            <textarea name="alamat" rows="2" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500" required placeholder="Contoh: Jl. Pesantren No. 99, Blok A">{{ old('alamat') }}</textarea>
                        </div>
                        
                        <div class="lg:col-span-2">
                            <label class="block text-sm font-medium text-gray-700 mb-1">RT / RW</label>
                            <div class="flex gap-2">
                                <input type="text" name="rt" value="{{ old('rt') }}" placeholder="001" class="w-1/2 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                <input type="text" name="rw" value="{{ old('rw') }}" placeholder="002" class="w-1/2 rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                        </div>
                        ...
                        <div class="lg:col-span-3">
                            ...
                            <input type="text" name="kode_pos" value="{{ old('kode_pos') }}" placeholder="46xxx" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white shadow-md rounded-xl overflow-hidden mb-8 border border-gray-100">
                    ...
                    <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-8 divide-y md:divide-y-0 md:divide-x divide-gray-200">
                        ...
                        <div class="space-y-4">
                            <h4 class="font-bold text-gray-600 uppercase text-sm border-b pb-2 mb-4">Data Ayah Kandung</h4>
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                <div>
                                    ...
                                    <input type="number" name="thn_lahir_ayah" value="{{ old('thn_lahir_ayah') }}" placeholder="YYYY" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                            </div>
                            <div class="grid grid-cols-2 gap-2">
                                <div>
                        ...
                        <div class="space-y-4 pt-4 md:pt-0 md:pl-8">
                            <h4 class="font-bold text-gray-600 uppercase text-sm border-b pb-2 mb-4">Data Ibu Kandung</h4>
                            ...
                            <div class="grid grid-cols-2 gap-2">
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Thn Lahir</label>
                                    <input type="number" name="thn_lahir_ibu" value="{{ old('thn_lahir_ibu') }}" placeholder="YYYY" class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                                </div>
                            </div>
                            <div class="grid grid-cols-2 gap-2">
                                <div>
                ...
                <div class="fixed bottom-0 left-0 right-0 bg-white border-t p-4 z-50 md:static md:bg-transparent md:border-none md:p-0 md:mb-20">
                    <div class="max-w-7xl mx-auto flex justify-end gap-4">
                         <a href="{{ route('admin.candidates.index') }}" class="px-6 py-3 bg-white text-gray-700 border border-gray-300 rounded-lg font-bold hover:bg-gray-50 transition shadow-sm">
                            Batal
                        </a>
